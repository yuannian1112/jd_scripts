...
[task_local]
#东东玩家
20 0,16 * * * https://raw.githubusercontent.com/Ariszy/Private-Script/master/JD/zy_ddwj.js, tag= 东东玩家
================Loon==============
[Script]
cron "20 0,16 * * *" script-path= https://raw.githubusercontent.com/Ariszy/Private-Script/master/JD/zy_ddwj.js,tag= 东东玩家
===============Surge=================
东东玩家 = type=cron,cronexp="20 0,16 * * *",wake-system=1,timeout=3600,script-path= https://raw.githubusercontent.com/Ariszy/Private-Script/master/JD/zy_ddwj.js
============小火箭=========
东东玩家 = type=cron,script-path= https://raw.githubusercontent.com/Ariszy/Private-Script/master/JD/zy_ddwj.js, cronexpr="20 0,16 * * *", timeout=3600, enable=true
*/
const $ = new Env('东东玩家')
