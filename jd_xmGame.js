...
第一个CK失效会退出脚本
————————————————
入口：[8.13-8.31 小米-星空大冒险 (https://lzdz1-isv.isvjcloud.com/dingzhi/xiaomi/gameupd/activity/1272964?activityId=dz2108100000412302&shareUuid=62f577b661d64f198812f20d2a4d0465)]
============Quantumultx===============
[task_local]
#8.13-8.31 小米-星空大冒险
31 6,20 13-31 8 * https://raw.githubusercontent.com/smiek2221/scripts/master/gua_xmGame.js, tag=8.13-8.31 小米-星空大冒险, enabled=true

================Loon==============
[Script]
cron "31 6,20 13-31 8 *" script-path=https://raw.githubusercontent.com/smiek2221/scripts/master/gua_xmGame.js,tag=8.13-8.31 小米-星空大冒险
...
!(async () => {
  ...
  $.shareUuid = '62f577b661d64f198812f20d2a4d0465'
