/*京东试用ab版，多账号运行较长可能接口不稳定，建议下午到晚上多运行几次
cron "30 10 * * *"
*/
const $ = new Env('京东试用')
