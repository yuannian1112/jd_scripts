/*
cron 14 2,10 * * * https://raw.githubusercontent.com/smiek2121/scripts/master/jd_sign_graphics.js
只支持nodejs环境
需要安装依赖
...
const validator = require('./utils/JDJRValidator_Pure1.js');
const Faker=require('./utils/sign_graphics_validate1.js')
