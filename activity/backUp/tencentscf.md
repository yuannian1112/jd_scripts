...
>
> - 本地安装依赖使用serverless部署，[点这里](activity/backUp/tencentscf.md#1-安装-nodejs-环境)
> - Github Action 部署[点这里](activity/backUp/tencentscf.md#github-action-部署)
...
![测试函数](https://user-images.githubusercontent.com/6993269/99628053-5a9eea80-2a70-11eb-906f-f1d5ea2bfa3a.png)
## 6. 设置触发器[看这里](activity/backUp/iCloud.md#5设置触发器) 或者看这里的[注释说明](https://github.com/iouAkira/jd_scripts/blob/patch-1/index.js#L4)
