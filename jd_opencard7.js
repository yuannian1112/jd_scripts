...
没有适配加购变量 所以是不加购
————————————————
入口：[8.8-8.14 七夕会员福利社 (https://lzdz1-isv.isvjcloud.com/dingzhi/shop/league/activity/7277549?activityId=dz2108100001616201&shareUuid=bb19580017fc4298b5d5860bec618d3b)]

============Quantumultx===============
[task_local]
#8.8-8.14 七夕会员福利社
18 0,21 8-14 8 * https://raw.githubusercontent.com/smiek2221/scripts/master/gua_opencard7.js, tag=8.8-8.14 七夕会员福利社, enabled=true
...
!(async () => {
  ...
  $.shareUuid = 'bb19580017fc4298b5d5860bec618d3b'
