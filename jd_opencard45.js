...
[task_local]
#10.19-10.25 大牌强联合 好物提前购
38 1,20 * * * jd_opencard39.js, tag=10.19-10.25 大牌强联合 好物提前购, enabled=true

================Loon==============
[Script]
cron "38 1,20 * * *" script-path=jd_opencard39.js,tag=10.19-10.25 大牌强联合 好物提前购

===============Surge=================
10.19-10.25 大牌强联合 好物提前购 = type=cron,cronexp="38 1,20 * * *",wake-system=1,timeout=3600,script-path=jd_opencard39.js

============小火箭=========
10.19-10.25 大牌强联合 好物提前购 = type=cron,script-path=jd_opencard39.js, cronexpr="38 1,20 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    $.shareUuid = 'f90830372a384ebca3353cf671dadc71'
    $.activityId = 'dz2021101420000sjleowq'
    console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7545342?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
...
function shopactivityId(functionId) {
    return {
        ...
        headers: {
            ...
            'Referer': `https://shopmember.m.jd.com/shopcard/?venderId=${functionId}&shopId=${functionId}&venderType=5&channel=401&returnUrl=https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7545342?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            'Cookie': cookie
        }
    }
}
    ...
    return new Promise(resolve => {
        $.post({
            ...
            headers: {
                ...
                'Referer':`https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7545342?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
...
function adLog() {
    return new Promise(resolve => {
        let pageurl = `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7545342?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
        $.post({
...
function getHtml() {
    return new Promise(resolve => {
        $.get({
            url: `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/7545342?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            headers: {
                'User-Agent': $.UA,
                'Host':'lzdz1-isv.isvjcloud.com',
