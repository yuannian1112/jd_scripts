...
————————————————
入口：[8.28-9.10 奔跑吧 开学季2 (https://lzdz-isv.isvjcloud.com/dingzhi/union/kxj/activity/8729993?activityId=902082701&shareUuid=3f63314095404f7dbdbfa3138164424f)]
...
!(async () => {
    ...
    $.shareUuid = '3f63314095404f7dbdbfa3138164424f'
    $.activityId = '902082701'
    console.log(`入口:\nhttps://lzdz-isv.isvjcloud.com/dingzhi/union/kxj/activity/8729993?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
...
function shopactivityId(functionId) {
    return {
        ...
        headers: {
            ...
            'Referer': `https://shopmember.m.jd.com/shopcard/?venderId=${functionId}&shopId=${functionId}&venderType=5&channel=401&returnUrl=https://lzdz-isv.isvjcloud.com/dingzhi/union/kxj/activity/8729993?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            'Cookie': cookie
        }
    }
}
...
function accessLogWithAD() {
    return new Promise(resolve => {
        let pageurl = `https://lzdz-isv.isvjcloud.com/dingzhi/union/kxj/activity/8729993?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
...
function getCk() {
    return new Promise(resolve => {
        let get = {
            url:`https://lzdz-isv.isvjcloud.com/dingzhi/union/kxj/activity/8729993?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
...
function taskPostUrl(url, body) {
    return {
        ...
        headers: {
            ...
            "Referer": `https://lzdz-isv.isvjcloud.com/dingzhi/union/kxj/activity/8729993?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            "User-Agent": $.UA ,
        }
    }
}
