...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_7144501ba4ee1,jd_59b8237af23d3,jd_GlyNFxpVmFTe,jd_oOvWUJHWJGpQ'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_7144501ba4ee1,jd_59b8237af23d3,jd_GlyNFxpVmFTe,jd_oOvWUJHWJGpQ'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["jd_7144501ba4ee1,jd_59b8237af23d3,jd_GlyNFxpVmFTe,jd_oOvWUJHWJGpQ"]
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          run_pins = [...new Set(run_pins)];
           let fixPins = run_pins.splice(run_pins.indexOf('jd_7144501ba4ee1'), 1);
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_59b8237af23d3'), 1));
